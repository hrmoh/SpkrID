...
/////////////////////////////////////////////////////////////////////
bool CxShadeButton::CxDib::IsWin30Dib(){
	return ((*(LPDWORD)(hDib))==sizeof(BITMAPINFOHEADER));
}
/////////////////////////////////////////////////////////////////////
WORD CxShadeButton::CxDib::GetPaletteSize()
{
//    if (IsWin30Dib())
...
/////////////////////////////////////////////////////////////////////
BYTE* CxShadeButton::CxDib::GetBits()
{ 
	if (hDib)	return ((BYTE*)hDib + *(LPDWORD)hDib + GetPaletteSize()); 
	return NULL;
}
/////////////////////////////////////////////////////////////////////
HDIB  CxShadeButton::CxDib::Create(DWORD dwWidth, DWORD dwHeight, WORD wBitCount)
{
...
/////////////////////////////////////////////////////////////////////
long CxShadeButton::CxDib::Draw(HDC pDC, long xoffset, long yoffset)
{
	if((hDib)&&(pDC))  {
...
/////////////////////////////////////////////////////////////////////
long CxShadeButton::CxDib::Stretch(HDC pDC, long xoffset, long yoffset, long xsize, long ysize)
{
	if((hDib)&&(pDC)) {
		//palette must be correctly filled
		LPSTR lpDIB = (char*)hDib;	//set image to hdc...
...
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::SetPaletteIndex(BYTE idx, BYTE r, BYTE g, BYTE b)
{
	if ((hDib)&&(m_nColors)){
...
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::SetPaletteIndex(BYTE idx, RGBQUAD c)
{
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
		if ((idx>=0)&&(idx<m_nColors)){	
...
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::SetPaletteIndex(BYTE idx, COLORREF cr)
{
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
		if ((idx>=0)&&(idx<m_nColors)){	
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CxShadeButton::CxDib::GetPaletteIndex(BYTE idx)
{
	RGBQUAD rgb = {0,0,0,0};
	if ((hDib)&&(m_nColors)){
		BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
...
/////////////////////////////////////////////////////////////////////
BYTE CxShadeButton::CxDib::GetPixelIndex(long x,long y)
{
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CxShadeButton::CxDib::GetPixelColor(long x,long y)
{
	RGBQUAD rgb={0,0,0,0};
...
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::SetPixelIndex(long x,long y,BYTE i)
{
	if ((hDib==NULL)||(m_nColors==0)||
...
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::SetPixelColor(long x,long y,RGBQUAD c)
{
	if ((hDib==NULL)||(x<0)||(y<0)||
...
/////////////////////////////////////////////////////////////////////
BYTE CxShadeButton::CxDib::GetNearestIndex(RGBQUAD c)
{
...
/////////////////////////////////////////////////////////////////////
RGBQUAD CxShadeButton::CxDib::RGB2RGBQUAD(COLORREF cr)
{
	RGBQUAD c;
...
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::SetGrayPalette()
{
...
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::BlendPalette(COLORREF cr,long perc)
{
	if ((hDib==NULL)||(m_nColors==0)) return;
	BYTE* iDst = (BYTE*)(hDib) + sizeof(BITMAPINFOHEADER);
	long i,r,g,b;
...
/////////////////////////////////////////////////////////////////////
long CxShadeButton::CxDib::GetSize()
{
	return m_bi.biSize + m_bi.biSizeImage + GetPaletteSize();
}
/////////////////////////////////////////////////////////////////////
BOOL CxShadeButton::CxDib::IsValid()
{
	return (hDib!=NULL);
}
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::Clone(CxDib *src)
{
 	Create(src->GetWidth(),src->GetHeight(),src->GetBitCount());
 	if (hDib) memcpy(hDib,src->hDib,GetSize());
}
/////////////////////////////////////////////////////////////////////
void CxShadeButton::CxDib::Clear(BYTE bval)
{
